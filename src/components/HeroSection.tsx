 ...
 * HeroSection
 *
 * FONTOS: minHeight: '250vh'
 *   → A GlobOrb ScrollTrigger-nek elég scroll távolság kell a 3 fázishoz.
 *     (fog áll → fog→gömb → sarokba megy)
 *   → A tartalom (szöveg, gombok) sticky-vel a viewport tetején marad!
 *
 * CSS class-ok:
 *   section-dark → Navigation tudja hogy sötét háttéren van
 *   id="hero"    → GlobOrb ScrollTrigger trigger-e
 */
const HeroSection = () => (
  <section
    id="hero"
    className="section-dark relative"
    style={{ minHeight: '250vh', backgroundColor: '#0a1628' }}
  >
    {/* Sticky belső doboz: a szöveg a viewport tetején marad végig */}
    <div
      className="sticky top-0 flex flex-col justify-center px-8 md:px-16 lg:px-24 pt-32"
      style={{ height: '100vh' }}
    >
