...
// ToothScene KIKAPCSOLVA – a GlobOrb fog animáció veszi át a szerepét
...
const Footer = () => {
  ...
  return (
    <footer
      className="relative pt-32 pb-12 rounded-t-[60px] md:rounded-t-[100px] -mt-20 z-20 overflow-hidden"
      style={{ backgroundColor: 'hsl(220, 40%, 13%)' }}
    >
      <NoiseOverlay />
      {/* ToothScene helyett a GlobOrb fog-ja animál ide */}

      {/* Minimális placeholder hogy a GlobOrb-nak legyen középső helye */}
      <div
        className="relative z-10 flex justify-center items-center"
        style={{ minHeight: '260px' }}
      >
        {/* A fog 3D animáció ide kerül (GlobOrb fixed, ebbe a zónába animál) */}
      </div>
